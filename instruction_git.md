...
Присоединяет к той ветке, в которой находимся мы, ту, имя которой указываем. В случе возникновения конфликта, появляется редактор, который позволяет разрешить конфликт: или совмещением, или выбором той, которую нужно оставить, или,что вернее всего - ручной корректировкой.